...
<head>
    ...
    <title>Affiliate Account Created</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;background:#ffffff;border-radius:14px;overflow:hidden;border:1px solid #e5e7eb;">
                    <tr>
                        <td style="padding:24px;background:#000000;color:#ffffff;">
                            ...
                            @endif
                            <div style="font-size:12px;letter-spacing:1px;text-transform:uppercase;opacity:.85;">Affiliate Account</div>
                    ...
                    <tr>
                        <td style="padding:26px 24px;">
                            ...
                            <p style="margin:0 0 16px;line-height:1.6;color:#4b5563;">
                                Your affiliate account has been created by our team. Use the credentials below to sign in.
                            </p>
                            <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:14px 16px;margin-bottom:14px;">
                                ...
                                <div style="font-size:15px;font-weight:600;color:#0f172a;">{{ $affiliate->email }}</div>
                            </div>
