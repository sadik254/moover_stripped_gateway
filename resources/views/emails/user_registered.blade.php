                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;background:#ffffff;border-radius:14px;overflow:hidden;border:1px solid #e5e7eb;">
                    <tr>
                        <td style="padding:24px;background:#000000;color:#ffffff;">
                            ...
                            @endif
                            <div style="font-size:12px;letter-spacing:1px;text-transform:uppercase;opacity:.85;">Account Created</div>
                            <div style="font-size:28px;font-weight:700;line-height:1.3;">Welcome to {{ $platformName }}</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:26px 24px;">
                            ...
                            <p style="margin:0 0 10px;line-height:1.6;color:#4b5563;">
                                Your account has been registered successfully.
                            </p>
                            <p style="margin:0 0 22px;line-height:1.6;color:#4b5563;">
                                You can now sign in and start managing your bookings.
                            </p>

                            <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:14px 16px;margin-bottom:20px;">
                                <div style="font-size:12px;text-transform:uppercase;letter-spacing:.8px;color:#64748b;margin-bottom:6px;">Account Email</div>
