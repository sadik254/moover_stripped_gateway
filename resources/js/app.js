...
const formDefinitions = {
    ...
    'vehicle-class': [field('name', 'Class name', 'text', { required: true }), field('description', 'Description', 'textarea'), field('capacity', 'Passenger capacity', 'number', { required: true, min: 1 }), field('luggage', 'Luggage capacity', 'number', { required: true, min: 0 }), field('hourly_rate', 'Hourly rate', 'number', { step: '0.01' }), field('peak_hourly_rate', 'Peak hourly rate', 'number', { step: '0.01' }), field('point_to_point_rate', 'Short point-to-point rate', 'number', { step: '0.01' }), field('per_mile_rate', 'Long-distance rate per mile', 'number', { step: '0.01' }), field('extra_stop_eligible', 'Apply extra-stop fee', 'checkbox')],
...
const resourceConfig = {
    ...
    'vehicle-classes': { endpoint: '/vehicle-classes', columns: ['ID', 'Class', 'Capacity', 'Hourly', 'Peak', 'Short trip', 'Per mile', 'Airport rates', 'Actions'] },
