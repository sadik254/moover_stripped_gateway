...
const formDefinitions = {
    ...
    'vehicle-class': [field('name', 'Class name', 'text', { required: true }), field('description', 'Description', 'textarea'), field('capacity', 'Passenger capacity', 'number', { required: true, min: 1 }), field('luggage', 'Luggage capacity', 'number', { required: true, min: 0 }), field('hourly_rate', 'Hourly rate', 'number', { step: '0.01' }), field('peak_hourly_rate', 'Peak hourly rate', 'number', { step: '0.01' }), field('point_to_point_rate', 'Short point-to-point rate', 'number', { step: '0.01' }), field('fixed_km_rate', 'Fixed distance price', 'number', { step: '0.01' }), field('fixed_km_limit', 'Fixed distance limit (km)', 'number', { min: 0, step: '0.01' }), field('per_km_rate', 'Long-distance rate per km', 'number', { step: '0.01' }), field('extra_stop_eligible', 'Apply extra-stop fee', 'checkbox')],
